...
--------------------------------------------------------
--  pioasm -o ada -p CYW4343X.RP_WiFi.PIO_SPI picowi_pio.pio output.ads

pragma Style_Checks (Off);

with RP.PIO;

package CYW4343X.RP_WiFi.PIO_SPI is
   --  pragma Preelaborate;
   ...
   Picowi_Pio_Program_Instructions : RP.PIO.Program := (
         ...
         16#a042#,  --   7: nop                    side 0
         16#b042#,  --   8: nop                    side 1
         16#b042#,  --   9: nop                    side 1
         16#5001#,  --  10: in     pins, 1         side 1
